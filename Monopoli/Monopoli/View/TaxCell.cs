...
namespace Monopoli.View
{
    class TaxCell : Cell
    {
        ...
        public TaxCell(int id, Monopoli.View.DefaultCellsFactory.Position position, Size size, Point location, 
            string name, decimal value, Image image, string currency)
