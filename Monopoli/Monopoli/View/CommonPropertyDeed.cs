...
namespace Monopoli.View
{
    public class CommonPropertyDeed : Deed
    {
        ...
        private void InitializeComponent()
        {
            ...
            _nameLabel.BackColor = Color.FromName(_groupColor);
            //
            // _rentDataPanel
            //
            ...
            _rentDataPanel.RowCount = _rentValues.Length;
            ...
            valueLabel.Text = _currencySymbol + " " + _rentValues[i].ToString();
            ...
            for (i = 1; i < _rentValues.Length; i++)
            {
                ...
                else if (i == _rentValues.Length - 1)
                {
            ...
            descriptionLabel = new Label();
            descriptionLabel.Dock = DockStyle.Fill;
            descriptionLabel.Text = "Costo di un Albergo più "+ (_rentValues.Length - 1) +" Case";
            valueLabel = new Label();
            valueLabel.Dock = DockStyle.Fill;
            valueLabel.Text = _currencySymbol + " " + _houseCost;
            valueLabel.Font = _valueFont;
            ...
            valueLabel.Dock = DockStyle.Fill;
            valueLabel.Font = _valueFont;
            valueLabel.Text = _currencySymbol + " " + _sellValue;
            descriptionLabel.TextAlign = ContentAlignment.MiddleLeft;
            valueLabel.TextAlign = ContentAlignment.MiddleCenter;
            _houseCostPanel.Controls.Add(descriptionLabel);
            _houseCostPanel.Controls.Add(valueLabel);
