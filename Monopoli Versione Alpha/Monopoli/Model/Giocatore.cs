...
namespace Monopoli.Model
{
    ...
    {
        public event EventHandler<LogEventArgs> PositionChanged;
        public event EventHandler<LogEventArgs> MoneyChanged;
        public event EventHandler<LogEventArgs> PlayerQuit;
